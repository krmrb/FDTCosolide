          ...
          <tr>
            <th @click="$emit('trier', 'dateDebutAbsence')" style="cursor: pointer">
              <span style="white-space: nowrap;">
                <i class="bi bi-calendar-event text-primary" title="Date d'absence"></i> Date d'absence
            ...
            <th @click="$emit('trier', 'corpsEmploi')" style="cursor: pointer">
              <span style="white-space: nowrap">
                <i class="bi bi-briefcase text-success" title="Emploi"></i> Emploi
                <i :class="getIcon('corpsEmploi')"></i>
              </span>
            </th>
            <th @click="$emit('trier', 'lieuTravail')" style="cursor: pointer">
              <span style="white-space: nowrap">
                <i class="bi bi-geo-alt text-success" title="Lieu de travail"></i> Lieu de travail
                <i :class="getIcon('lieuTravail')"></i>
              </span>
            </th>
            <th @click="$emit('trier', 'motif')" style="cursor: pointer">
              <span style="white-space: nowrap">
                <i class="bi bi-chat-left-text text-warning" title="Motif"></i> Motif
                <i :class="getIcon('motif')"></i>
              </span>
            </th>
            <th @click="$emit('trier', 'etat')" style="cursor: pointer">
              <span style="white-space: nowrap">
                <i class="bi bi-info-circle text-danger" title="État"></i> État
                <i :class="getIcon('etat')"></i>
              </span>
            </th>
            <th>
              <span style="white-space: nowrap">
                <i class="bi bi-sticky text-info" title="Note"></i> Note
              </span>
            </th>
            <th>
              <span style="white-space: nowrap">
                <i class="bi bi-gear text-secondary" title="Actions"></i> Actions
              </span>
            </th>
          </tr>
        </thead>
