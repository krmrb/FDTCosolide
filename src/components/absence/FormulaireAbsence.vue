<template>
  <div class="mt-4 p-4">
    ...
    <div class="modal-header border-0">
        <button type="button" class="btn-close close-button" @click="$emit('fermer')" aria-label="Fermer"></button>
      </div>
    ...
    <div class="modal-footer">
      ...
      <button class="btn btn-secondary" @click="$emit('fermer')">Enregistrer</button>
      <button class="btn btn-success" @click="soumettre">{{ mode === 'ajout' ? '✅ Envoyer' : '✅ Modifier' }}</button>
