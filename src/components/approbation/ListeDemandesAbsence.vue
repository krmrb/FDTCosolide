<template>
  <div class="main-container">
    <div class="mb-3">
      <h3 class="text-primary mt-2">Approbation des demandes d'absences</h3>
    </div>
    <div class="ms-2">
      <div class="row g-2 align-items-end">
        ...
        <div class="col-md-2">
          ...
          <select class="form-select filtre-input">
            ...
            <option v-for="motif in motifsAbsence" :key="motif.label" :value="motif.code">
              {{ motif.motifsCode }} - {{ motif.motifsLabel }}
            </option>
          </select>
        </div>
        ...
        <div class="col-md-2">
          ...
          <input type="text" class="form-control filtre-input" list="initiateurs"
        ...
        <table class="table-demandes">
          <thead class="">
            <tr>
              ...
              <th class="text-middle col-date-de"><i class="bi bi-calendar-event-fill me-1 text-primary"></i> Date d'absence
              </th>
              <th class="text-start col-nom"><i class="bi bi-person-circle me-1 text-success"></i> Initiée par</th>
              <th class="text-start col-empl"><i class="bi bi-briefcase-fill me-1 text-success"></i> Emploi</th>
              <th class="text-middle col-lieu"><i class="bi bi-geo-alt-fill me-1 text-success"></i> Lieu de travail</th>
...
const motifsAbsence = motifAbsenceData.motifAbsence.map((obj: { code: any; description: any }) => ({
  motifsCode: obj.code,
  motifsLabel: obj.description
}));
