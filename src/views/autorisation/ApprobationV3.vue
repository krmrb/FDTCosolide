...
<script setup lang="ts">
  ...
  import ListeDemandes from '@/components/autorisation/ListeDemandesV3.vue'
  import ListeDemandesPaiement from '@/components/autorisation/ListeDemandesPaiementV3.vue'
  import CreationDemande from "@/components/autorisation/CreationDemande.vue"
  import ApprobationDetails from '@/components/approbation/ApprobationDetailsV3.vue'
  import ApprobationDetailsPaiement from '@/components/approbation/ApprobationDetailsPaiementV3.vue'
