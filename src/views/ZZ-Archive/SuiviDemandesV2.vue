<template>
  <div class="container-fluid d-flex justify-content-center mt-4">
    <div class="row ma-container align-items-stretch"> 
      <!-- Colonne gauche : Détails avec bordure droite -->
      <div class="col-md-5 p-4 colonne-gauche">
        <h2 class="mb-4">Demande de {{labelMotif}} <span v-if="!estEnCreation">- Suivi</span></h2>
        <div class="details-suivi" v-if="!estEnCreation">
          ...
          <div class="ma-container bg-light mt-3 p-2">
      ...
      <div class="col-md-6 bg-light p-4 colonne-droite">
...
<script setup lang="ts">
  ...
  watch(() => props.evenement?.etatValidation, (val) => {
    console.log('Changement de validation :', val)
  })
...
<style scoped>
  ...
  /* Optionnel : réduire la taille globale */
  .container-fluid {
    font-size: 0.9rem;
  }
