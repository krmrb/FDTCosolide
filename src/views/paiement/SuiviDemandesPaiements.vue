<template>
  ...
  <main class="main-content bg-white flex-column flex-fill p-3 p-sm-5 pt-sm-3 min-vh-100">
    ...
    <div class="d-flex justify-content-start mb-3">
      <button class="btn btn-primary mb-3 me-2" @click="ouvrirPopup(null)">Nouvelle demande ...</button>
          ...
          <tr>
            <th @click="trierPar('dateDemande')" style="cursor: pointer">
              <span style="white-space: nowrap;">
                <i class="bi bi-calendar-range-fill text-success"></i> Date de paiement
            ...
            <th @click="trierPar('corpsEmploi')" style="cursor: pointer">
              <span style="white-space: nowrap;"><i class="bi bi-briefcase-fill text-success"></i> Emploi
              <i :class="getIcon('corpsEmploi')"></i></span>
            </th>
            <th @click="trierPar('lieuTravail')" style="cursor: pointer">
              <span style="white-space: nowrap;"><i class="bi bi-geo-alt-fill text-success"></i> Lieu de travail
            ...
            <th @click="trierPar('etat')" style="cursor: pointer">
              <i class="bi bi-info-circle-fill text-danger"></i> État
              <i :class="getIcon('etat')"></i>
            </th>
            <th><i class="bi bi-sticky-fill text-info" title="Note"></i> Notes</th>
            <th><i class="bi bi-gear-fill text-secondary"></i> Actions</th>
          </tr>
        </thead>
        <tbody>
            ...
            <td align="center">
              <span style="white-space: nowrap;">
                <button v-if="demande.etat !== 'Brouillon'" class="btn btn-sm" @click="voirDetails(demande)">
                  <i class="bi bi-eye text-secondary" title="Voir les détails"></i>
                </button>
                <button v-if="estModifiable(demande)" class="btn btn-sm" @click="ouvrirPopup(demande)">
                  <i class="bi bi-pencil-square text-secondary" title="Modifier"></i>
                </button>
