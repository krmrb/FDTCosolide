<template>
   ...
   <main class="main-content bg-white flex-column flex-fill p-3 p-sm-5 pt-sm-3">
      <div class="container text-start">
         <h3 class="mb-4 text-primary mt-2">Horaire</h3>
         ...
         <h4 id="calendar-title" class="fw-bold mb-0 mx-auto"></h4>
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#elementModal">Nouvelle demande d'absence</button>
         </div>
         <!-- Modale Bootstrap -->
